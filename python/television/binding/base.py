# https://raw.githubusercontent.com/django/channels/fb6b467c7a7bdd203e25851684742dc48ec1ea42/channels/binding/base.py
...
class Binding(object):
    ...
    def send_messages(self, instance, group_names, action, **kwargs):
        ...
        for group_name in group_names:
            print(f'group_name={group_name} stream={self.stream} payload={payload}')
            television.utils.send_to_group(group_name, self.stream, payload)
